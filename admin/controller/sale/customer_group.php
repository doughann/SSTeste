...
class ControllerSaleCustomerGroup extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['reward_percentage'])) {
			$this->data['reward_percentage'] = $this->request->post['reward_percentage'];
		} elseif (!empty($customer_group_info)) {
			$this->data['reward_percentage'] = $customer_group_info['reward_percentage'];
		} else {
			$this->data['reward_percentage'] = '';
		}	

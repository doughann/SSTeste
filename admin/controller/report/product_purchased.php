...
class ControllerReportProductPurchased extends Controller { 
	...
	//Echo "---------------".$order."---------------";
		$this->data['sort_name'] = $this->url->link('report/product_purchased', 'token=' . $this->session->data['token'] . '&sort=pd.name' . $url, 'SSL');
		$this->data['sort_total'] = $this->url->link('report/product_purchased', 'token=' . $this->session->data['token'] . '&sort=total' . $url, 'SSL');
		$this->data['sort_quantity'] = $this->url->link('report/product_purchased', 'token=' . $this->session->data['token'] . '&sort=quantity' . $url, 'SSL');

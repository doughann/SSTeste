 ...
 class ControllerModuleComboProducts extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->redirect($this->url->link('module/comboproducts', 'token=' . $this->session->data['token'], 'SSL'));
		}
	...
	protected function getList (){
		...
		$url = '';
       $this->data['insert'] = $this->url->link('module/comboproducts/add', 'token=' . $this->session->data['token'], 'SSL');
		$this->data['delete'] = $this->url->link('module/comboproducts/delete', 'token=' . $this->session->data['token'], 'SSL');	
		...
		$this->template = 'module/comboproducts_list.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	protected function getForm () {
		...
		if (isset($this->error['combo_name'])) {
			$this->data['error_combo_name'] = $this->error['combo_name'];
		} else {
			$this->data['error_combo_name'] = '';
		}
		
		if (isset($this->error['combo_products'])) {
			$this->data['error_combo_products'] = $this->error['combo_products'];
		} else {
			$this->data['error_combo_products'] = '';
		}
		
		if (isset($this->error['discount_number'])) {
			$this->data['error_discount_number'] = $this->error['discount_number'];
		} else {
			$this->data['error_discount_number'] = '';
		}
		...
		if (!isset($this->request->get['combo_id'])) {
			$this->data['action'] = $this->url->link('module/comboproducts/add', 'token=' . $this->session->data['token'] . $url, 'SSL');
		} else {
			$this->data['action'] = $this->url->link('module/comboproducts/edit', 'token=' . $this->session->data['token'] . '&combo_id=' . $this->request->get['combo_id'] . $url, 'SSL');
		}
		
		$this->data['cancel'] = $this->url->link('module/comboproducts', 'token=' . $this->session->data['token'] . $url, 'SSL');
       ...
       $this->data['breadcrumbs'][] = array(
		...
		$this->template = 'module/comboproducts_form.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);

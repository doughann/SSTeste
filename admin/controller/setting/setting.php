...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->error['email_cozinha'])) {
			$this->data['error_email_cozinha'] = $this->error['email_cozinha'];
		} else {
			$this->data['error_email_cozinha'] = '';
		}
		...
		if (isset($this->request->post['config_email_cozinha'])) {
			$this->data['config_email_cozinha'] = $this->request->post['config_email_cozinha'];
		} else {
			$this->data['config_email_cozinha'] = $this->config->get('config_email_cozinha');
		}
	...
	protected function validate() {
		...
		if ((utf8_strlen($this->request->post['config_email_cozinha']) > 96) || !preg_match('/^[^\@]+@.*\.[a-z]{2,6}$/i', $this->request->post['config_email_cozinha'])) {
			$this->error['email_cozinha'] = $this->language->get('error_email');
		}

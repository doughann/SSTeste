...
<div id="content">
    <div class="box">
        ...
        <div class="content">
            ...
            <p>Make sure you have uploaded all Journal files to your server and successfully replaced <b>system/engine/front.php</b> and <b>admin/model/setting/extension.php</b> files.</p>

      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general">
          <table class="form">
			...
			<tr>
              <td>E-mail da Cozinha</td>
              <td><input type="text" name="config_email_cozinha" value="<?php echo $config_email_cozinha; ?>" size="40" />
                <?php if ($error_email_cozinha) { ?>
                <span class="error"><?php echo $error_email_cozinha; ?></span>
                <?php } ?></td>
            </tr>
            <tr>

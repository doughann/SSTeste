	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right pad-bottom-sm">
				<?php $disabled = ($save_type == 'auto') ? 'disabled="disabled"' : ''; ?>
				<a onclick="saveSettings($(this))" class="btn btn-primary" <?php echo $disabled; ?>><i class="fa fa-floppy-o pad-right-sm"></i> <?php echo ($disabled) ? $standard_autosaving_enabled : $button_save; ?></a>

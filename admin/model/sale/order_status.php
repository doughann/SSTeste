...
class ModelLocalisationOrderStatus extends Model {
	...
	public function getOrderMethods(){
		$sql = "SELECT shipping_method FROM " . DB_PREFIX . "order WHERE shipping_method!='' and date_added>='2016-02-01 00:00:00'group by shipping_method order by shipping_method";
		$query = $this->db->query($sql);

		return $query->rows;

	}
	public function getOrderDTimes(){
		$sql = "SELECT ddw_time_slot FROM " . DB_PREFIX . "order WHERE shipping_method!='' and date_added>='2016-02-01 00:00:00'group by ddw_time_slot order by ddw_time_slot";
		$query = $this->db->query($sql);

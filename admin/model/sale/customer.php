...
class ModelSaleCustomer extends Model {
	...
	public function editCustomer($customer_id, $data) {
		...
		if (isset($data['epontosreward'])) {
			foreach ($data['epontosreward'] as $pontosreward) {
				$this->db->query("UPDATE " . DB_PREFIX . "customer_reward SET points = '" . (int)$pontosreward['pontos'] . "' where order_id='".(int)$pontosreward['order_id']."'");
	...
	public function getTotalRewards($customer_id) {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "customer_reward WHERE customer_id = '" . (int)$customer_id . "'  and ativo='1'");

		return $query->row['total'];
	}

	public function getRewardTotal($customer_id) {
		$query = $this->db->query("SELECT SUM(points) AS total FROM " . DB_PREFIX . "customer_reward WHERE customer_id = '" . (int)$customer_id . "'  and ativo='1'");

		return $query->row['total'];
	}		

	public function getTotalCustomerRewardsByOrderId($order_id) {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "customer_reward WHERE order_id = '" . (int)$order_id . "'  and ativo='1'");

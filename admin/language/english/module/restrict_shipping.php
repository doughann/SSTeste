...
// Heading
//------------------------------------------------------------------------------
$_['heading_title']						= 'Restrict ' . $type . ' Methods';
...
$_['help_restrictions']					= 'By default, shipping methods are available based on their own settings. Use "Rules" to further restrict when they are available, based on specific criteria such as geo zone or customer group.';
$_['heading_restrictions']				= 'Restrictions';

$_['column_action']						= 'Action';
$_['column_group']						= 'Name';
$_['column_method']						= 'Shipping Methods';
...
$_['help_restriction_methods']			= 'Select the shipping methods to restrict. These methods will only be available when all rules are met.<br /><br />To limit the restriction to a specific rate within a method, select the method here and use a "Shipping Rate" rule for the rate name.';
...
$_['help_add_rule']						= 'The selected methods will only be available when all rules are met. Rules of different types will be combined using AND logic, and rules of the same type using OR logic. For example, if you add these rules:<br /><br />&bull; Customer Group is Wholesale<br />&bull; Geo Zone is United States<br />&bull; Geo Zone is Canada<br /><br />then the method will only be available when the customer is part of the Wholesale group <b>AND</b> the location is in the United States <b>OR</b> Canada.';
...
$_['help_total_value']					= 'The cart&#39;s Sub-Total is normally used for calculations involving the total. To change this, use one of the following:<br /><br />&bull; <b>Pre-Discounted Sub-Total:</b> the sub-total of all products&#39; original prices, ignoring Special or Discount prices<br /><br />&bull; <b>Non-Discounted Sub-Total:</b> the sub-total not including products with Special or Discount pricing<br /><br />&bull; <b>Taxed Sub-Total:</b> the sub-total including any tax on products<br /><br />&bull; <b>Total:</b> the total at the point of the ' . ($type == 'Shipping' ? '"Shipping" Order Total.<br /><br />Products that do not require shipping are NOT included in values based on the sub-total.' : '"Total" Order Total.');
...
$_['help_cart_criteria_comparisons']	= '
	...
	<b>of every item</b> = compare the value against every item individually; if any do not qualify, the restriction will not apply
	<hr />
	Values are normally compared only against eligible items (i.e. those that qualify based on other rules). To compare values against all items in the cart, including ineligible ones, choose a comparison containing "entire cart".';
...
$_['text_date']							= 'Date';
$_['text_time']							= 'Time';
$_['help_day']							= 'Choose the day of the week that this restriction applies. Create multiple rules if you want it to apply on multiple days.';
$_['help_date']							= 'YYYY-MM-DD';
$_['help_time']							= 'HH:MM (12-23 for PM)';
$_['help_datetime_criteria']			= 'Choose when the restriction starts or ends. Use the format YYYY-MM-DD for dates and HH:MM for times. Use 12-23 for the PM hours.';
...
$_['help_geo_zone']						= 'Select a geo zone, or select "Everywhere Else" to have the restriction apply to anywhere not in a geo zone.';
$_['help_location_comparison']			= 'By default, location criteria are compared against the ' . ($type == 'Shipping' ? 'shipping' : 'payment') . ' address. Use this setting to change this behavior.';
...
$_['help_customer_group']				= 'Select a customer group, or select "Guests" to have the restriction apply to customers not logged in to an account.';
$_['help_language']						= 'Select a language.';
$_['help_past_orders_dropdown']			= 'Choose how to compare customer&#39;s past orders: Days, Quantity, or Total. For example:<br /><br />&bull; To have the restriction apply to customers who have placed an order within the past 30 days, choose "Days" and enter 0-30<br /><br />&bull; To have the restriction apply to customers with at least 2 past orders, choose "Quantity" and enter 2<br /><br />&bull; To have the restriction apply to customers whose past orders total $500 to $1000, choose "Total" and enter 500-1000';
...
$_['help_option_value']					= 'Enter a value (such as Small) or a range (such as 25-50). Products that have the specified option with the value or within the range will be eligible for this restriction. Leave this field blank to allow for any option value.<br /><br />If the option value can include a hyphen, use :: in place of - for ranges. Ranges are inclusive of the end values. Separate multiple ranges using commas.';
...
$_['help_other_product_data']			= 'Enter a value (such as ABC001X) or a range (such as 500-1000). Products that match this value or have a value in this range will be eligible for this restriction.<br /><br />If product data includes hyphens, use :: in place of - for ranges. Ranges are inclusive of the end values. Separate multiple ranges using commas.<br /><br />For example, if you choose "model" for the database column, and then enter "Model XYZ" (without quotes) in the field, any product with a matching model will be eligible.';
...
$_['help_product_groups']				= 'Product groups are used to restrict methods based on a group of categories, manufacturers, and/or products.';
...
$_['help_rule_sets']					= 'Rule sets are used to apply multiple rules to a single restriction at once. You can reuse the same rule set to quickly create the restrictions you need.';
...
//------------------------------------------------------------------------------
$_['help_shipping_rate']				= 'Enter a shipping rate title (such as Priority Mail) or multiple titles separated by commas (such as Priority Mail, Express Mail). This restriction will only apply to these specific shipping rates within the selected shipping method(s).';
?>
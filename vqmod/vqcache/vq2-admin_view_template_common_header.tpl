...
<link type="text/css" href="view/javascript/pos/keyboard.css" rel="stylesheet" />
<script type="text/javascript" src="view/javascript/jquery/tabs.js"></script>
<script type="text/javascript" src="view/javascript/jquery/superfish/js/superfish.js"></script>
<script type="text/javascript" src="view/javascript/common.js"></script>
<script type="text/javascript" src="view/javascript/jquery/ui/i18n/jquery.ui.datepicker-pt-BR.js"></script>
...
<script type="text/javascript" src="view/javascript/stringToSlug/jquery.stringToSlug.min.js"></script>	<script type="text/javascript">			$(document).ready( function() {		$("#title-slug").stringToSlug({			setEvents: 'keyup keydown blur',			getPut: '#slug-result',		});	});	</script>
</head>
<body>
<div id="container">
    <div id="header">
...
<li id="pos"><a class="top" href="index.php?route=module/pos/main&token=<?php echo $this->session->data['token'] ?>">Point Of Sale</a></li>

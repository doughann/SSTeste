...
class ControllerCommonHeader extends Controller {
	protected function index() {
				...
				$this->data['get_installed'] = array();
				$this->data['get_installed'] = $this->model_setting_extension->getInstalled('module');
				if (isset($this->session->data['token'])) $this->data['combo_module'] = $this->url->link('module/comboproducts', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->language->load('common/header');
				...
				$this->data['text_combo_module'] = $this->language->get('text_combo_module');
